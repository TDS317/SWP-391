    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            if (request.getParameter("id") != null) {
                size = gdb.getSizeOfList1(request.getParameter("key"), request.getParameter("id"));
            } else {
                size = gdb.getSizeOfList1(request.getParameter("key"));
            }
            ...
            List<Guarantee> list;
            if (request.getParameter("id") != null) {
                list = gdb.getListByPage1(start, numperpage, request.getParameter("key"),request.getParameter("id"));
            } else {
                list = gdb.getListByPage1(start, numperpage, request.getParameter("key"));
            }
