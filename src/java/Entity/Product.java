...
public class Product {
    ...
    public Product(int ProductID, String ProductName, String BrandName, String CategoryName, String Price, int Discount, int Quantity, String LargeImage, String BrandID) {
        this.ProductID = ProductID;
        this.ProductName = ProductName;
        this.BrandName = BrandName;
        this.CategoryName = CategoryName;
