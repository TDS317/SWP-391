                    ...
                    <div class="tile">
                        <div class="tile-body">
                            <div class="row element-button">
                                <c:if test="${acc.getRoleID() == 1}">
                                    <div class="col-sm-2">
                                        <a class="btn btn-add btn-sm" href="tableaddorder" title="Thêm"><i class="fas fa-plus"></i>
                                            Tạo mới đơn hàng</a>
                                    </div>
                                    <div class="col-sm-2">
                                ...
                                <table class="table table-hover table-bordered mb-2" id="sampleTable">
                                    <thead>
                                        <tr style="background: #eee">
                                            ...
                                            <th class="text-center" style="width:9%">Chức Năng</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <c:if test="${list != null && !empty list}">
                                            <c:forEach items="${list}" var="l">
                                                <tr>
                                                    ...
                                                    <td class="text-center">${l.getU().getUserName()}</td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button class="btn btn-primary btn-sm eye" type="button" title="Chi tiết đơn hàng" 
                                                                onclick="getPa('${l.getOrderID()}', '${pageContext.request.contextPath}', '','','','','','${l.getU().getUserID()}')">
