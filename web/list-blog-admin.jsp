                ...
                <div class="col-md-12">
                    <div class="tile">
                        <div class="tile-body">
                            ...
                            <form style="width: 100%"  method="get" action="list-blog-admin">
                                <input type="text" class="form-control" style="width: 20%; display: inline-block" name="search" placeholder="Search by title or author name..." > <button style="padding: 12px 15px" class="btn btn-primary">Go</button>
                            </form>
                            ...
                            <div class="pagination-arena">
                                <ul class="pagination">
                                    <li class="page-item"><a href="./list-blog-admin?index=1&search=${param['search']}" class="page-link"><i class="fa fa-angle-left" aria-hidden="true"></i></a></li>
                                    <li class="page-item">
                                        <a href="./list-blog-admin?index=${index-2}&search=${param['search']}" class="page-link ${index-2<1?"d-none":""}">${index-2}</a></li>
                                    <li class="page-item">
                                        <a href="./list-blog-admin?index=${index-1}&search=${param['search']}" class="page-link ${index-1<1?"d-none":""}">${index-1}</a></li>
                                    <li class="page-item active">
                                        <a href="./list-blog-admin?index=${index}&search=${param['search']}" class="page-link">${index}</a></li>
                                    <li class="page-item">
                                        <a href="./list-blog-admin?index=${index+1}&search=${param['search']}" class="page-link ${index+1>numberPage?"d-none":""}" >${index+1}</a></li>
                                    <li class="page-item">
                                        <a href="./list-blog-admin?index=${index+2}&search=${param['search']}" class="page-link ${index+2>numberPage?"d-none":""}">${index+2}</a></li>
                                    <li><a href="./list-blog-admin?index=${numberPage}&search=${param['search']}" class="page-link"><i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
                                </ul>
                            </div> 
                        </div>
                    </div>
