                        ...
                        <div class="tile-body">
                            <form class="row" action="addorder" id="frm" method="post">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control" name="nameU" type="text" value="${user.getUserName()}" readonly>
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="control-label">Số điện thoại khách hàng</label>
                                    <input class="form-control" name="phone" type="text" value="${user.getPhone()}" readonly>
                                </div>
                                <div class="form-group  col-md-6">
                            ...
                            <a class="btn btn-cancel ml-2" href="tableaddorder?key=${key}&entryperpage=${entryperpage}&page=${page}">Hủy bỏ</a>
                        </div>
                    </div>
                    </main>
