                        ...
                        <div class="col-lg-7 col-md-12 col-12">
                            ...
                            <div class="right-content">
                                <ul class="list-main">
                                    ...
                                    <li><i class="ti-user"></i> <a href="register.jsp">Sign up</a></li>
                                </ul>
                            </div>
                            <!-- End Top Right -->
                        </div>
                                    ...
                                    <div class="row-blogs">
                                        <c:forEach var="b" items="${list}">
                                            <div class="col-blog">
                                                ...
                                                <h3 style="margin-top: 10px;font-weight: bold"><a href="blog-detail?id=${b.getNewsID()}" >${b.getTitle()}</a></h3>
                                            </div>
                            ...
                            <div class="single-widget recent-post">
                                ...
                                <c:forEach var="b" items="${newest}">
                                    <div class="single-post">
                                        ...
                                        <div class="content">
                                            <h5><a href="blog-detail?id=${b.getNewsID()}">${b.getTitle()}</a></h5>
                                            <ul class="comment">
