            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tile">
                        ...
                        <div class="tile-body">
                            <form class="row" action="guaranteeAddConfirm?&userID=${OrderInfo.getUserID()}&productID=${OrderInfo.getProductID()}&dateGuarantee=${OrderInfo.getGuarantee()}&adminName=${acc.getAdminName()}" method="post" enctype="multipart/form-data">
