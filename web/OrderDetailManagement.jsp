        ...
        <main class="container" style="display: none" id="info_PDF">
            ...
            <div id="d1" class="row justify-content-between align-items-center" style="margin: 10px; margin-bottom: 10px;">
                ...
                <div class="col-xs-6 mb-0">
                    <input onclick="generatePDF()" class="btn btn-success" type="button" id="Export" value="Xuất file PDF">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="widget-timeline-icon">
                                <ul class="timeline-1">
                                    <c:if test="${list[0].getOrder().getShipDate() == null}">
                                        <li class="event">
